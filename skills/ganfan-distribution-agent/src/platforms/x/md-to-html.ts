...
Usage:
  bun src/platforms/x/md-to-html.ts <markdown_file> [options]
...
Example:
  bun src/platforms/x/md-to-html.ts article.md --output json
  bun src/platforms/x/md-to-html.ts article.md --html-only > /tmp/article.html
  bun src/platforms/x/md-to-html.ts article.md --save-html /tmp/article.html
`);
  process.exit(0);
}
