...
- 发布偏好：`mantle/media_substrate/publishing/profiles/x.yaml`
- X Article 实现：`src/platforms/x/`
- 主入口：`npm run publish:x:article -- <03-成稿/article_with_images.md> [--cover <path>] [--title <text>] [--submit]`
...
- 标准输入优先使用 `03-成稿/article_with_images.md`
