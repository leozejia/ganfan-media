...
import { loadWechatProfile, resolveWechatBrowserDebugPort, resolveWechatBrowserProfileDir } from './nexus-profile.ts';
...
Options:
  ...
  --profile <dir>    Chrome profile directory (default: Nexus wechat profile)
